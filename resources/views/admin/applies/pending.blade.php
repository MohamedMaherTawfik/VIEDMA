    ...
    <div class="p-6 bg-white min-h-screen">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.users.create') }}"
                class="bg-[#176b98CE] text-white px-4 py-2 rounded-lg shadow hover:bg-[#176b98]">
                Add User +
            </a>
        ...
        <div class="hidden md:grid grid-cols-7 gap-4 font-semibold text-gray-700 mb-2">
            ...
            <div class="text-[#176b98]">phone</div>
            <div class="text-[#176b98]">CV</div>
            <div class="text-[#176b98]">certificate</div>
            <div class="text-right mr-10 text-color text-[#176b98]">Action</div>
        </div>


        <!-- User List Container -->
        @foreach ($applies as $apply)
            <div class="grid grid-cols-7 gap-4 items-center bg-[##FEBE35] bg-white p-4 rounded-lg shadow mb-2">
                <!-- apply Info -->
                ...
                <a href="{{ asset('storage/' . $apply->cv) }}" target="_blank"
                    class="inline-flex items-center justify-center w-10 h-10 bg-[#176b98D0] text-white rounded-md hover:bg-[#176b98] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200">
                    <!-- PDF icon from Heroicons (Solid) -->
                    <i class="fa-solid fa-file-pdf text-[#FEBE35] text-xl"></i>
                </a>
                ...
                <a href="{{ asset('storage/' . $apply->certificate) }}" target="_blank"
                    class="inline-flex items-center justify-center w-10 h-10 bg-[#176b98D0] text-white rounded-md hover:bg-[#176b98] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200">
                    <!-- PDF icon from Heroicons (Solid) -->
                    <i class="fa-solid fa-file-image text-[#FEBE35] text-xl"></i>
                </a>
