    ...
    <div class="flex items-center justify-between p-4 rounded-lg shadow-sm">
        ...
        <div x-data="{ open: false }" class="relative inline-block text-left">
            ...
            <div x-show="open" @click.away="open = false" x-transition
                ...
                <div class="py-1">
                    <a href="{{ route('teacher.project.create', $course->slug) }}"
                    ...
                    <a href="{{ route('teacher.project.show', request('slug')) }}"
                        class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-400" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path
                    ...
                    <form method="POST" action="{{ route('teacher.project.delete', $course->id) }}">
                        <button type="submit"
